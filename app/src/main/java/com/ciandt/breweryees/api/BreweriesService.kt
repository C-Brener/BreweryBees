...
interface BreweriesService {
    ...
    @GET("breweries/myEvaluations/{breweryId}")
    suspend fun getBreweriesEvaluations(@Path(value="breweryId", encoded = true) breweryId:String):ApiResponse<List<BreweriesModel>>
